...
public class FootprintStrategyPolarTest extends TestCase {

    private final FootprintStrategyPolar footprintStrategyPolar = new FootprintStrategyPolar();
    ...
    public void testPolarSide1Split() throws FootprintException {
        ...
        List<List<Coordinate>> coordsList = footprintStrategyPolar.merge(s1, b, s2, t);
        Geometry geometry = footprintStrategyPolar.mergeGeoms(coordsList, 0.5);
